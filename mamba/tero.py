...
class Tero:
    ...
    def show_skills(self):
        ...
        show_border()
        print(
            "\nI learned about Collaborating using GitHub"
            "and managing repositories.\n"
            "I also learned python, including proper syntax and logic.\n"
            "Like using functions and creating reusable modules in Python.\n"
        )
        show_border()
        press_enter()
